...
const Modal = ({ title, children, name }) => {
    ...
    return (
        <>
            <div className="flex justify-end px-1 md:px-4">
                <button
            ...
            {modalToggle ? (
                <>
                    <div
                        ...
                        onClick={() => setModalToggle(!modalToggle)}
                    ></div>
                    <div className="top-1/2 left-1/2 z-10 absolute bg-white p-4 rounded w-[95%] lg:w-1/3 transform -translate-x-1/2 -translate-y-1/2">
